...
void main() {
  //COMMENTING CODE
  //Statements is comment is not executed by compiler
  ...
  //we can use it to comment a line
  //We can use it to comment multiple lines
  // This is line1
  // This is line2
  // This is line3
  ...
  */
  //Nesting comments:
  //comments can be inside other comments
  /*Outer comment
    //Inner comment
    //Other inner comment
  */
  ...
  //When pressed enter in VS Code, it automatically comments next line
  ...
  */
  ...
  //STATEMENT
  //A statement is a command, something we tell the computer to do
  //print is simple statement example and if statement is complex statement
  //every statement in dart must end with semicolon.

  //EXPRESSIONS
  //Expression is a value or it is something that can be calculated as a value
  //Examples 
  //42, 3 + 2
