...
void main() {
  ...
  var desserts = ['cookies', 'cupcakes','donuts']; // Here desserts is the list and is of type string
  ...
  */
  ...
  const desserts = [
    ...
    'cupcakes',
    'donuts'
  ]; //This is same as , final desserts = const['cookies','cupcakes','donuts'];
  ...
  */
  ...
  // Challenges
  // Challenge 1:
  // String para ="Fear leads to anger; anger leads to hatred; hatred leads to conflict; conflict leads to suffering.";
  ...
  // Challenge 3:
//   User user1 = User(1, 'Deep');
//   User user2 = User(2, 'Rishi');
//   User user3 = User(3, 'Aayush');
